...
user ="vjraghav998test@gmail.com"; //"YourEmailId@gmail.com" // email id to send the emails
...
String from ="vjraghav998test@gmail.com"; //Email id of the recipient
String subject="Successfully Registered in server 2";
